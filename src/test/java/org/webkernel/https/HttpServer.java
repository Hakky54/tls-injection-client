    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                HttpResponse<byte[]> response = requestFunction.processRequest(socket, null);// requestBuilder);
                rawOut.write(
                        ("HTTP/1.1" + " "
                ...
                rawOut.write("Date: Wed, 12 Jun 2024 12:28:53 GMT\r\n".getBytes(StandardCharsets.UTF_8));
                rawOut.write("Server: Apache/2.2.14 (Win32)\r\n".getBytes(StandardCharsets.UTF_8));
                rawOut.write("Last-Modified: Wed, 22 Jul 2009 19:15:56 GMT\r\n".getBytes(StandardCharsets.UTF_8));
                rawOut.write(("Content-Length: " + response.body().length + "\r\n").getBytes(StandardCharsets.UTF_8));
